    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [taxRes, regRes, serRes, reeRes, otRes, basicRes, sefRes] =
          await Promise.all([
            fetch(
              `http://192.168.101.109:3001/api/TaxOnBusinessTotalESREBox?${params}`
            ),
            fetch(
              `http://192.168.101.109:3001/api/RegulatoryFeesAndChargesTotalESREBox?${params}`
            ),
            fetch(
              `http://192.168.101.109:3001/api/ServiceUserChargesTotalESREBox?${params}`
            ),
            fetch(
              `http://192.168.101.109:3001/api/ReceiptsEconomicEnterprisesTotalESREBox?${params}`
            ),
            fetch(
              `http://192.168.101.109:3001/api/OtherTaxesTotalESREBox?${params}`
            ),
            fetch(
              `http://192.168.101.109:3001/api/RealPropertyTaxSharingTotalBox?${params}`
            ),
            fetch(
              `http://192.168.101.109:3001/api/RealPropertyTaxSharingSEFTotalBox?${params}`
            ),
          ]);
